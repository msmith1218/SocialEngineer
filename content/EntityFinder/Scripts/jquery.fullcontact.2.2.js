...
(function ($) {
    $.fullcontact = {
        ...
        companyLookupEndpoint: 'v2/company/lookup.json',
        ...
        companyLookup: function (apiKey, company, onComplete, options) {
            options = options || {};
            options.domain = company;
            var url = this.buildURL(this.companyLookupEndpoint, apiKey, options);
            this.executeRequest(url, 'GET', null, onComplete);
        }
    };
